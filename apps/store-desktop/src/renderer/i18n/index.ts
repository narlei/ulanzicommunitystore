...
Image paths are relative to your repo root.`,
  ...
  pt: {
    ...
    submitReadyText: 'Esta é a sua entrada no registry. Clique no botão abaixo: o GitHub faz o fork do repositório da loja, cria o arquivo e abre o Pull Request. Sem edição manual.',
