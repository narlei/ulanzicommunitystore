...
Image paths are relative to your repo root.`,
  ...
  pt: {
    ...
    securityShortError: 'Indisponivel',
    ...
    openErrorLogHelp: 'Veja detalhes tecnicos de erros recentes (ex: falhas na instalacao) para ajudar a diagnosticar problemas.',
    openErrorLogButton: 'Abrir logs',
    openErrorLogError: 'Nao consegui abrir o arquivo de logs de erro.',
